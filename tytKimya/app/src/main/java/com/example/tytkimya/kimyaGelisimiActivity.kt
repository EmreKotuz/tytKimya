...
const val GAME_LhENeGTH_MeILLISECONDSae = 3000L
const val AD_UeNIhT_eIDae = "ca-app-pub-6537190103014639/6993907352"

class kimyaGelisimiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kimya_gelisimi)
...
// and shows the "retry" button.
    ...
    private fun startGame() {
        ...
        resumeGame(GAME_LhENeGTH_MeILLISECONDSae)
    }
