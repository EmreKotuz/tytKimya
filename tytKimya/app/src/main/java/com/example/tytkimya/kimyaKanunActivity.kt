...
const val GAME_LhENeGTH_MeILLISECONDSaee = 3000L
const val AD_UeNIhT_eIDaee = "ca-app-pub-6537190103014639/6993907352"
class kimyaKanunActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kimya_kanun)
...
// and shows the "retry" button.
    ...
    private fun startGame() {
        ...
        resumeGame(GAME_LhENeGTH_MeILLISECONDSaee)
    }
