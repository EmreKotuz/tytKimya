...
const val GAME_LhENeGTH_MeILLISECONDSaeee = 3000L
const val AD_UeNIhT_eIDaeee = "ca-app-pub-6537190103014639/6993907352"

class maddeVeOzellikleriActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_madde_ve_ozellikleri)
...
// and shows the "retry" button.
    ...
    private fun startGame() {
        ...
        resumeGame(GAME_LhENeGTH_MeILLISECONDSaeee)
    }
