...
const val GAME_LhENeGTH_MeILLISECONDSaeeee = 3000L
const val AD_UeNIhT_eIDaeeee = "ca-app-pub-6537190103014639/6993907352"
class molKavramActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mol_kavram)
...
// and shows the "retry" button.
    ...
    private fun startGame() {
        ...
        resumeGame(GAME_LhENeGTH_MeILLISECONDSaeeee)
    }
