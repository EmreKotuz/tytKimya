...
const val GAME_LhENeGTH_MeILLISeECONDSaae = 3000L
const val AD_UeNIhT_eIDaae = "ca-app-pub-6537190103014639/6993907352"

class bilesiklerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bilesikler)
...
// and shows the "retry" button.
    ...
    private fun startGame() {
        ...
        resumeGame(GAME_LhENeGTH_MeILLISeECONDSaae)
    }
